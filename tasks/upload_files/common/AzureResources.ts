...
export class AzureResources {
    ...
    constructor(taskParameters: task.TaskParameters) {
        ...
        this.ResourceManagementClient = armResource.ResourceManagementClient;
        this.StorageManagementClient = armStorage.StorageManagementClient;
    }
     ...
     */
    private async createResourceGroupIfRequired(client: armResource.ResourceManagementClient) {
     ...
     */
    private async deleteResourceGroupIfExists(client: armResource.ResourceManagementClient) {
        let exists = await this.checkResourceGroupExists(client);
     ...
     */
    private checkResourceGroupExists(client: armResource.ResourceManagementClient): Promise<boolean>  {
     ...
     */
    private async createResourceGroup(client: armResource.ResourceManagementClient): Promise<void> {
     ...
     */
    private async deleteResourceGroup(client: armResource.ResourceManagementClient): Promise<void> {
        return new Promise<void> ((resolve, reject) => {
     ...
     */
    private async createStorageAccountIfRequired(client: armStorage.StorageManagementClient) {
    ...
    private async checkStorageAccountExists(client: armStorage.StorageManagementClient) {
    ...
    private async createStorageAccount(client: armStorage.StorageManagementClient): Promise<void> {
        return new Promise<void> ((resolve, reject) => {
            ...
            let parameters = {
                "location": this.taskParameters.location,
                "sku": {
                    "name": this.taskParameters.storageAccountType
                },
                "kind": "Storage"
            }

            client.storageAccounts.create(this.taskParameters.resourceGroupName,
                                            this.taskParameters.storageAccountName,
                                            parameters,
                                            {},
                                            (error, result, request, response) => {
                if (error) {
                    return reject(tl.loc("StorageAccountCreationFailed", Utils.getError(error)))
                }
    ...
    private async createContainerIfRequired(client: armStorage.StorageManagementClient) {
    ...
    private async checkContainerExists(client: armStorage.StorageManagementClient) {
    ...
    private async createContainer(client: armStorage.StorageManagementClient): Promise<void> {
        return new Promise<void> ((resolve, reject) => {
    ...
    private async createSASToken(client: armStorage.StorageManagementClient): Promise<Array<string>> {
    ...
    private async uploadFilesToContainer(): Promise<void> {
        return new Promise<void> ((resolve, reject) => {
            ...
            for (let item of items) {
                ...
                // upload the item
                this.BlobService.createBlockBlobFromLocalFile(this.taskParameters.containerName, name, item, {}, (error, result, response, request) => {
                    if (error) {
